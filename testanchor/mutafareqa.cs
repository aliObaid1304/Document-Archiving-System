...
{
    public partial class mutafareqa : MetroFramework.Forms.MetroForm
    {
        ...
        public static int class_ind = 0; // for recipets and mutferqa
        ...
        private void mutafareqa_Load(object sender, EventArgs e)
        {
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)
            {
                ...
                metroTextBox1.Text = "";
                metroTextBox3.Text = "";
                rec_amount = metroTextBox1.Text;
                rec_date = dateTimePicker1.Value;
                rec_amount = metroTextBox3.Text;
            }
        }
        ...
        public void add_records_todb(ArrayList array_list_of_files)
        {
            ...
            Sader_Modeller sader_mo = new Sader_Modeller()
            {
                ...
                post_source_sader = "E:\\archieve\\mutafarqa\\" + last_id + ".pdf",
                class_indecator = class_ind.ToString(),
                rec_no = metroTextBox1.Text,
                rec_date = dateTimePicker1.Value,
                rec_amount = metroTextBox3.Text,
            };
            ...
            if (sader_mo.addtodb(sader_arraylist) == true)
            {
                ...
                if (fileExt == ".png" || fileExt == ".jpg")
                {
                    ...
                    {
                        document.Save("E:\\archieve\\mutafarqa\\" + last_id + ".pdf");
                ...
                else if (fileExt == ".pdf")
                {
                    ...
                    try
                    {
                        ...
                        string pdfFilename = "E:\\archieve\\mutafarqa\\" + last_id + ".pdf";
                    ...
                    try
                    {
                        ...
                        if (scannerDevice != null)
                        {
                            ...
                            if (scanResult != null)
                            {
                                ...
                                try
                                {
                                    Path = @"E:\archieve\mutafarqa\temp\" + counter + ".jpg";
