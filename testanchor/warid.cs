...
{
    public partial class warid :MetroFramework.Forms.MetroForm
    {
        ...
        private void warid_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void add_records_todb(ArrayList array_list_of_files)
        {
            ...
            Sader_Modeller sader_mo = new Sader_Modeller()
            {
                ...
                post_source_sader = "E:\\archieve\\warid\\" + last_id + ".pdf",
                class_indecator = "2",
                rec_no = "",
            ...
            if (sader_mo.addtodb(sader_arraylist) == true)
            {
                ...
                if (fileExt == ".png" || fileExt == ".jpg")
                {
                    ...
                    {
                        document.Save("E:\\archieve\\warid\\" + last_id + ".pdf");
                ...
                else if (fileExt == ".pdf")
                {
                    ...
                    try
                    {
                        ...
                        string pdfFilename = "E:\\archieve\\warid\\" + last_id + ".pdf";
                    ...
                    try
                    {
                        ...
                        if (scannerDevice != null)
                        {
                            ...
                            if (scanResult != null)
                            {
                                ...
                                try
                                {
                                    Path = @"E:\archieve\warid\temp\" + counter + ".jpg";
